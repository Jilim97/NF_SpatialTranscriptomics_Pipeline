...
ST.FeaturePlot(se, features = c(head(VariableFeatures(se),2)), split.labels = F, indices = 1,pt.size = 2.5)
ST.FeaturePlot(se, features = c(head(VariableFeatures(se),2)), split.labels = F, indices = 2,pt.size = 2.5)
```

```{r, sptial plot with sample images}
FeatureOverlay(se, features = c(head(VariableFeatures(se),2)), spots = rownames(subset(se[[]])),sampleids = 1, pt.alpha = 0.8, pt.size = 2.5)

FeatureOverlay(se, features = c(head(VariableFeatures(se),2)), spots = rownames(subset(se[[]])),sampleids = 2, pt.alpha = 0.8, pt.size = 2.5)
```
...
ST.FeaturePlot(se, features = "seurat_clusters", split.labels = F, indices = 1,pt.size = 2.5)

ST.FeaturePlot(se, features = "seurat_clusters", split.labels = F, indices = 2,pt.size = 2.5)
...
FeatureOverlay(se, features = "seurat_clusters", spots = rownames(subset(se[[]])),sampleids = 1, pt.alpha = 0.8, pt.size = 3.2)

FeatureOverlay(se, features = "seurat_clusters", spots = rownames(subset(se[[]])),sampleids = 2, pt.alpha = 0.8, pt.size = 3.5)
```
